    ...
    def get_new_node_key(self, node_dict):
        ...
        while True:
            ...
            if new_id not in node_dict:
                ...
                # Se o ID gerado já existir, tente gerar um novo ID único.
                # Você também pode adicionar alguma lógica para lidar com isso, como gerar um novo ID de uma maneira diferente.
                pass  # Aqui você pode adicionar sua lógica de tratamento, se necessário.
